...
def main():
    ...
    image_path = "C:/Users/Malek AJJEL/Downloads/PIM-Finale/heart_disease_web/pexels-negativespace-48604 (1).jpg"
    ...
    with col3:
        st.image("C:/Users/Malek AJJEL/Downloads/PIM-Finale/heart_disease_web/WhatsApp_Image2-removebg-preview.png", width=400, use_container_width=False, output_format="auto", clamp=False, channels="RGB", caption=None)
    ...
    @st.cache_data
    def load_data():
        data = pd.read_csv("C:/Users/Malek AJJEL/Downloads/PIM-Finale/trainTest.csv", encoding="latin-1")
        return data
...
# Analyse Exploratoire
    ...
    # Modélisation
       ...
       # Visualiser la courbe ROC pour le modèle optimisé
        ...
        fig, ax = plt.subplots(figsize=(10, 8))
        ax.plot(fpr, tpr, color='blue', lw=2, label=f'Random Forest Optimisé (AUC = {roc_auc:.3f})')
        ax.plot([0, 1], [0, 1], linestyle='--', color='gray', label="Ligne de base")
    ...
    if choice == "🔍 Prédictions":
        ...
        with st.form("prediction_form"):
            ...
            if submitted:
                ...
                file_path = "C:/Users/Malek AJJEL/Downloads/PIM-Finale/patient_data.csv"
